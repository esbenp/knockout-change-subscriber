(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['knockout', 'knockout-mapping', 'jquery', 'underscore'], factory);
  } else if (typeof exports === 'object') {
    module.exports = factory(require('knockout'), require('knockout-mapping'), require('jquery'), require('underscore'));
  } else {
